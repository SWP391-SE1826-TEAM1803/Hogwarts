                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a class="btn btn-outline-warning btn-icon-text" href="UserControllerURL?service=update&id=<%=user.getUserID()%>">
                                        <i class="mdi mdi-refresh"></i> Update
                                    </a>
                                    <a class="btn btn-outline-danger btn-icon-text" href="UserControllerURL?service=delete&id=<%=user.getUserID()%>">
